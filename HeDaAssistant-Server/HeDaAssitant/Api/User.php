    ...
    public function getRules() {
        return array(
            ...
            'changePassword' => array(
                'id' =>  array('name' => 'user_id', 'type' => 'int', 'min' => 1, 'require' => true, 'desc' => '用户ID'),
                'old_password' =>  array('name' => 'old_password', 'require' => true, 'desc' => '用户密码'),
                'new_password' => array('name' => 'new_password', 'require' => true, 'desc' => '用户密码'),
            )
...
//
//        $where['user_id']=$this-> userId;
//        $where['old_password']=$this->old_password;
//
//
//        if(DI()->notorm->user->where($where)->getOne()){
//
//
//            $data=array(
//                'user_id' =>$this->id;
